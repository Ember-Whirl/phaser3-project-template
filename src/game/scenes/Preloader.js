...
export class Preloader extends Scene
{
    ...
    preload ()
    {
        ...
        // Load bubble pop sounds
        for (let i = 0; i < 3; i++) {
            this.load.audio(`bubble-pop${i}`, `audio/bubble-pop${i}.mp3`);
        }
        ...
        this.load.once('complete', () => {
            ...
            this.load.on('complete', () => {
                if (this.manifestAssetsLoaded && !this.mainMenuStarted) {
                    ...
                    PortalManager.gameLoadingFinished();
    ...
    loadAssetsFromManifest ()
    {
        ...
        if (folders.length === 0) {
            ...
            // No assets to load — trigger transition immediately
            if (!this.mainMenuStarted) {
                this.mainMenuStarted = true;
                PortalManager.gameLoadingFinished();
                this.scene.start('MainMenu');
            }
